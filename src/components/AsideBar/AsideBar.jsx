...
const routes = ['/home', '/inventory', '/orders', '/transfers', '/notifications', '/settings'];
...
export default function AsideBar() {
  ...
  const allowedIndexes = isAdmin ? [0, 1, 2, 3] : [0, 1, 2, 3, 4, 5, 6];

  return (
    <aside className='w-64 h-full bg-white dark:bg-gray-900 shadow-lg flex flex-col justify-between'>
      <div>
        <h2 className='h-12 text-center content-center font-extrabold dark:text-white'>INVENTORY MANAGEMENT</h2>
